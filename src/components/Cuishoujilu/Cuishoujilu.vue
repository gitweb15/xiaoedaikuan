<template>
	<div class="cuishoujilu">
		<div class="top">
			...
			<span>首页/催收管理/<span>催收记录</span></span>
			<router-link to="/daoqi">Daoqi</router-link>
		</div>
		<div class="sousuo">
...
<style scoped>
	...
	.biaoge>table>tr:nth-of-type(1)>td:nth-of-type(1){
		width: 1%;
	}
	...
	.biaoge>table>tr>td:nth-of-type(11){
		width: 8%;		
	}
	.biaoge>table>tr>td{
		width: 4%;
